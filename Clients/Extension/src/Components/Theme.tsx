...
export default function Theme({ handleTheme }: { handleTheme: (key: string, values: any) => void }) {
  // console.log(internal)
  //handleTheme("theme", (internal.theme === "dark" ? "light" : "dark"))
  return (
    <div
      onClick={() => handleTheme("theme", ({ theme }: { theme: "dark" | "light" }) => (theme === "dark" ? "light" : "dark"))}
