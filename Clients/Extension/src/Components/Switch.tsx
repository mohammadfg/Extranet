  ...
  return (
    <>
      <div className="flex after:last:gap-2 justify-center mt-5">
        ...
        ></label>
        <div className=" before:content-['/'] before:text-gray-400 before:absolute before:text-8xl before:top-10 ltr:before:left-[7.5rem] rtl:before:right-[7.5rem] ltr:ml-9 before:font-mono">
